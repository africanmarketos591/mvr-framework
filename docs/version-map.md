...
Current patch `.2` also preserves behavioral replay assertions through client-safe HTTP projection. Live verification caught that visibility gap in `.1`; output permissions remain unchanged.
...
| `deployment_revision` | `2026-09-27.outsider-review.2` | In-band application build identifier. The provider-generated deployment revision is recorded separately after deployment. |
...
The [declared evidence-lineage update](declared-evidence-lineage-2026-09-06.md) documents shared-reference checks introduced in `.4` and the overlap notices and calibration-health scope clarification in deployment `2026-09-06.engine-contract.5`.

The [attestation and outcome scope update](calibration-attestation-and-outcome-scope.md) documents full-manifest readiness exports and three review-workflow request contracts in deployment `2026-09-06.engine-contract.6`.
