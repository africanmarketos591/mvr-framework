...
| `deployment_revision` | `2026-08-04.input-integrity-policy.2` | In-band application build identifier. The provider-generated deployment revision is recorded separately after deployment. |
