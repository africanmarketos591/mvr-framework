...
| `deployment_revision` | `2026-09-12.engine-contract.1` | In-band application build identifier. The provider-generated deployment revision is recorded separately after deployment. |
