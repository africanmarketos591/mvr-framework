...
| `deployment_revision` | `2026-09-07.engine-contract.4` | In-band application build identifier. The provider-generated deployment revision is recorded separately after deployment. |
