...
| `deployment_revision` | `2026-09-06.engine-contract.4` | In-band application build identifier. The provider-generated deployment revision is recorded separately after deployment. |
...
The [declared evidence-lineage update](declared-evidence-lineage-2026-09-06.md) documents shared-reference checks and their independence limits in deployment `2026-09-06.engine-contract.4`.
