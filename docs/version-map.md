...
| `deployment_revision` | `2026-09-06.engine-contract.8` | In-band application build identifier. The provider-generated deployment revision is recorded separately after deployment. |
