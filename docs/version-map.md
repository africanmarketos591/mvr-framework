...
| `deployment_revision` | `2026-08-08.offer-routing-reconciliation.1` | In-band application build identifier. The provider-generated deployment revision is recorded separately after deployment. |
...
| `host_recipe_version` | `2026-08-08.1` | Microsoft, Google, AWS, OpenAI, Anthropic, and xAI recipe family. |
