...
| `deployment_revision` | `2026-09-08.engine-contract.10` | In-band application build identifier. The provider-generated deployment revision is recorded separately after deployment. |
